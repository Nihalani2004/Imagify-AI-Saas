...
setLoading(false) 
  ...
  return (
    ...
    <input onChange={e => setInput(e.target.value)} value={input} type="text" placeholder='Describe what you want to generate.' className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20' name="" id="" />
